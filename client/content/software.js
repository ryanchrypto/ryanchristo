export default [
  ...
  },
  {
    ...
    role: 'Web Developer',
    summary: 'Joglo Northwest is a family owned business that buys and sells Indonesian art, furniture and stone. I rebuilt their old site to accomadate for new ideas and simplify how content is managed and updated. The site includes a user-friendly content management system using simple-cms as the foundation.',
  ...
  },
  {
    ...
    role: 'Web Developer',
    summary: 'I started building simple-cms after completing a number of projects in the freeCodeCamp curriculum. The goal of the project was to create a reusable foundation for small business websites and to practice working on a larger application with React, Redux, Express and MongoDB.',
    tags: 'React, Redux, Webpack, PostCSS, SCSS, Node, Express, MongoDB',
    title: 'simple-cms',
    type: 'software',
  },
  {
    ...
    role: 'Web Developer',
    summary: 'After completing a Javascript workshop, I continued practicing and building projects with freeCodeCamp. The curriculum focuses on full stack Javascript development with React, Node, Express and MongoDB.',
    tags: 'React, Redux, Webpack, PostCSS, SCSS, Node, Express, MongoDB',
    title: 'fcc-projects',
    type: 'software',
  },
  {
    ...
    role: 'Web Developer',
    summary: 'Joglo Northwest is a family owned business that buys and sells Indonesian art, furniture and stone. The site includes a custom content management system using HTML, CSS, PHP and SQL.',
  ...
  },
  {
    ...
    role: 'Web Developer',
    summary: 'Greek Database was a language tool that I built for learning Classical Greek that included a dictionary, vocabulary, conjugation and declension flashcards, and reading exercises.',
    tags: 'HTML, CSS, PHP, SQL',
  ...
  },
  {
    ...
    role: 'Web Developer',
    summary: 'Documentary Art Network was one of first web development projects. I built the foundation for a professional network for documentary artists, where users could post stories on documentary artists, discuss project ideas, find people to collaborate with, and buy, sell, rent or exchange equipment.',
    tags: 'HTML, CSS, PHP, SQL',
